        ...
        <div className="mx-auto max-w-7xl w-full space-y-5 bg-gray-900/50 border border-slate-800  p-10 rounded-2xl">
          ...
          <div className="flex flex-col items-center justify-center space-y-6 mt-10">
            ...
            <div className="space-y-2 max-w-4xl text-lg">
              ...
              <p className=" leading-relaxed">- Role-based access control</p>
              <p className=" leading-relaxed">
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <p className=" font-bold text-xl sm:text-3xl">Product</p>
            </div>
            ...
            <div className="space-y-2 max-w-4xl text-lg  leading-relaxed">
            ...
            {/* <div className="flex items-center text-start gap-2 text-sky-500">
              <p className=" font-bold text-xl sm:text-3xl">Responsive</p>
            </div>
            <div className="space-y-2 max-w-4xl text-lg  leading-relaxed">
              <p>
