        ...
        <div className="mx-auto max-w-7xl w-full space-y-5 bg-gray-900/50 border border-slate-800  p-10 rounded-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <User className="" />
              <p className=" font-bold text-xl sm:text-2xl">Sign Up & Login</p>
            </div>
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <Home className="" />
              <p className=" font-bold text-xl sm:text-2xl">Home</p>
            </div>
            <div className="space-y-2">
              <p>
            ...
            <p>
              ...
              Additionally, users can also delete their user account by clicking
              the Delete button.
            </p>
            <div className="flex justify-start my-6">
              <Image
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <User2 />
              <p className=" font-bold text-xl sm:text-2xl">Character</p>
            </div>
            <div className="flex justify-start my-6">
              <Image
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <Heart />
              <p className=" font-bold text-xl sm:text-2xl">Add to favorite</p>
            </div>
            <div className="flex justify-start my-6">
              <Image
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              <MdPayment />
              <p className=" font-bold text-xl sm:text-2xl">Payment</p>
            </div>
            <div className="space-y-2">
              <p>
