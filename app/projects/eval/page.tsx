        ...
        <div className="mx-auto max-w-7xl w-full space-y-5 bg-gray-900/50 border border-slate-800  p-10 rounded-2xl">
          <div className="flex flex-col items-center justify-center space-y-5">
            ...
            <p className="sm:text-xl font-medium indent-8 leading-relaxed">
              ...
              performance on an annual basis. This system includes an online
              form designed to allow internal units, such as faculties, to input
              data on activities or operations related to the development of
              faculty members and the university. The system then follows a
              four-step process for data verification and approval: 1) Data
              Entry by Faculties/Units Internal units within the university
              (e.g., various faculties) fill out the form provided in the system
              with details of their activities or achievements. 2) Review by the
              Main Responsible Unit (Owner) The main responsible unit will
              review the data submitted by each faculty and decide whether to
              “include” or “exclude” it from the official report. 3) Request for
              Revision by Faculties (if excluded) If the submitted data is not
              included, the faculty may submit a revision or clarification
              request through the system. 4) Approval of Revision Requests by
              the Owner After the revision submission period ends, the
              responsible unit will approve or reject the revision requests
              submitted. This project is part of the work I was assigned, where
              I was responsible for developing and maintaining the back-end
              system using .NET MVC, jQuery, and SQL Server. SQL Server was used
