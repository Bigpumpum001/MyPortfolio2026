        ...
        <div className="mx-auto max-w-7xl w-full space-y-5 bg-gray-900/50 border border-slate-800  p-10 rounded-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center text-start gap-2 text-sky-500">
              ...
              <p className=" font-bold text-xl sm:text-2xl">Stock Log</p>
            </div>
            ...
            <p>
              -Timestamped transaction records This system reduces operational
              errors and supports future audit requirements.
            </p>
            <div className="flex items-center text-start gap-2 text-sky-500">
              <Receipt />
              <p className=" font-bold text-xl sm:text-2xl">Receipt History </p>
            </div>
            <div className="space-y-2">
              <p>
              ...
              <p>- Synchronized withdispensing systems.</p>
            </div>
